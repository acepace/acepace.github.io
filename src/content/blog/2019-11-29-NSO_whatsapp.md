...
![Over-the-air attacks are what NSO vulnerabilities are famous for.](/images/NSO/NSO-writeup0.png)

![For many attacks, phishing is effective, if the victim is convinced to press on a link.](/images/NSO/NSO-writeup1.png)


![In cases where the government can use fake base stations or acquire physical access to the machine, NSO also has physical layer vulnerabilities.](/images/NSO/NSO-writeup2.png)
...
![Android fragmentation is an issue also for offensive programmers.](/images/NSO/NSO-writeup3.png)


![NSO doesn’t take the hard path and says they won’t support non Chromium based browsers.](/images/NSO/NSO-writeup4.png)
...
![This time scale isn’t very surprising for enterprise deployments.](/images/NSO/NSO-writeup5.png)
...
![NSOs feature list also explicitly mentions the ability to silently activate the users microphone.](/images/NSO/NSO-writeup6.png)
...
![At this time, the malware was far from all powerful and in some cases could be uninstalled just by running a factory reset.](/images/NSO/NSO-writeup7.png)


![Like many other malware, Pegasus extracts pretty much all information stored on the phone. SMSs, iMessage, call logs and more are all fair game.](/images/NSO/NSO-writeup8.png)
...
![At the time, SS7 capabilities were pretty rare.](/images/NSO/NSO-writeup9.png)
...
![NSOs collection buffer makes it clear that operators need to pick the data they collect carefully if the phone may be away from network access for large periods of time.](/images/NSO/NSO-writeup10.png)
...
![It’s always nice when vendors invent fancy names for common tech. In this case, a chain of proxies in different geographical areas.](/images/NSO/NSO-writeup11.png)
...
![NSO takes care that Pegasus covers its tracks, but they absolve responsibility in case of operator mistakes/stupidity.](/images/NSO/NSO-writeup12.png)
...
![Malware typically kills itself when security software is detected or when it can’t reach its C2 server. Pegasus does both.](/images/NSO/NSO-writeup13.png)
...
![Backend analysis is just as important as collection and sometimes more important.](/images/NSO/NSO-writeup14.png)
...
![Very strict system requirements make it clear that the Pegasus system isn’t small or simple, nor is it a simple C2 server.](/images/NSO/NSO-writeup15.png)
...
![Prepaid SIM cards are becoming a hassle to buy, maybe also for governments :)](/images/NSO/NSO-writeup16.png)
...
![A unique problem for western offensive tool vendors is what happens if the government unilaterally revokes their export license.](/images/NSO/NSO-writeup17.png)
...
![When you buy from Israel - you buy Israel's legal restrictions](/images/NSO/NSO-writeup18.png)
...
![alt_text](/images/NSO/NSO-writeup19.png)


![alt_text](/images/NSO/NSO-writeup20.png)
